const Model = {
    ...
    currentIndex: 0,
    matches: [],
    // Datos estáticos de restaurantes (En una app real vendrían del backend)
    restaurants: [
    ...
    // Simulación DESACTIVADA para evitar matches fantasmas
    startSimulation: function(cb) {
        // Aquí iría el polling al backend real
    }
};